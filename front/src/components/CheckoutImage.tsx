    ...
    return (
        <div className={"CheckoutImage flex"}>
            ...
            <div className={"imageFrame flex items-center justify-center rounded-[8px] w-full overflow-hidden h-[240px] relative"}>
                <img className={"w-1/2"} src={gender === "male" ? maleBefore : femaleBefore} alt="before image male"/>
                <img className={"w-1/2"} src={gender === "male" ? maleAfter : femaleAfter} alt="after image male"/>
