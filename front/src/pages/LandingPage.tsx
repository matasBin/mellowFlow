    ...
    return (
        <div className={"LandingPage flex flex-col h-full w-full gap-6"}>
            <header className={"flex flex-col items-center gap-3"}>
                ...
                <p className={"font-normal text-[14px] leading-[18px] text-[#303030] text-center"}>We will use this to personalize your plan</p>
            </header>
            ...
            <main className={"flex flex-1 flex-col items-center justify-center"}>
                <div className="genderOptions w-[335px] h-[200px] flex justify-center gap-3 items-center">
                    ...
                    <div onClick={() => assignGender("male")}
                        ...
                        <div className="genderText rounded-b-[8px] h-[60px] bg-[#5349DB] flex justify-center items-center">
